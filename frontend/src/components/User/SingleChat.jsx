...
const ENDPOINT = "http://localhos/t/:8000"; // "https://talk-a-tive.herokuapp.com"; -> After deployment
...
const SingleChat = ({ AuctionId }) => {
    ...
    if (user && AuctionId) {
      try {
        ...
        if (data.noBidHistory) {
          ...
          setStartingBid(data.auction.startingBid);
  ...
  const sendMessage = async () => {
    if (newMessage > (messages[messages.length - 1]?.content || startingBid)) {
      ...
      toast({
        ...
        description: `Enter an amount greater than ${
