...
import { useListEnglishAuctionsAdminQuery } from "../../slices/adminApiSlice";
...
const AdminListEnglishAuctions = () => {
  ...
  const { data: allAuctions, error, refetch } = useListEnglishAuctionsAdminQuery()
  useEffect(() => {
    if (allAuctions) {
      ...
      <Box p={2}>
        <BreadCrumbs
          allPage={[
            ...
            { Name: "List English Auctions", Link: "/admin/listEnglishAuctions" },
          ]}
        />
      </Box>
      {auctions ? (
        ...
        <DrawerContent>
          ...
          <DrawerBody>
            ...
            <Box>
              ...
              <Box>
                <Text as="B">Starting Bid:</Text>
                <Text>{auctionDetail?.startingBid}</Text>
              </Box>
              <Box>
